...
class DataFlowInitializer {
	...
	public void deployOnStart(
			ApplicationReadyEvent e)
			throws Exception {

		// <1>
		DataFlowTemplate df = new DataFlowTemplate(
				baseUri,
				new RestTemplate());
		...
		TaskOperations taskOperations = df
				.taskOperations();
		Stream
				.of("batch-task",
						"simple-task")
